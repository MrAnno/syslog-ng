...
private:
  ...
  const google::protobuf::Message *msg_prototype;
  ...
  /* TODO: datastructure for dynamic schema */
  const google::protobuf::FieldDescriptor *message_field_descriptor;
  const google::protobuf::FieldDescriptor *event_source_field_descriptor;
  const google::protobuf::FieldDescriptor *time_field_descriptor;
  const google::protobuf::FieldDescriptor *host_field_descriptor;
  const google::protobuf::FieldDescriptor *extradata_field_descriptor;
  const google::protobuf::FieldDescriptor *ident_field_descriptor;
  const google::protobuf::FieldDescriptor *msgid_field_descriptor;
  const google::protobuf::FieldDescriptor *pid_field_descriptor;
};
