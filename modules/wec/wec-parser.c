...
extern int wec_debug;

int wec_parse(CfgLexer *lexer, LogDriver **instance, gpointer arg);
...
CfgParser wec_parser =
{
#if SYSLOG_NG_ENABLE_DEBUG
  .debug_flag = &wec_debug,
#endif
  .name = "wec",
  .keywords = wec_keywords,
  .parse = (gint (*)(CfgLexer *, gpointer *, gpointer)) wec_parse,
  .cleanup = (void (*)(gpointer)) log_pipe_unref,
};

CFG_PARSER_IMPLEMENT_LEXER_BINDING(wec_, LogDriver **)
