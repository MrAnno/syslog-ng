...
_decrease_window(LogSource *self)
{
  ...
  dynamic_window_release(self->dynamic_window.window_ctr, subtrahend);
}

static inline void
_increase_window(LogSource *self)
{
  gsize offered_dynamic = dynamic_window_request(self->dynamic_window.window_ctr, self->full_window_size);
...
_release_dynamic_window(LogSource *self)
{
  ...
  dynamic_window_release(self->dynamic_window.window_ctr, dynamic_part);
}
